...
def localhost():
    ...
    env.server_name = 'suwakiorg.example.com'
    env.server_admin = 'suwakiorg <suwakiorg@suwakiorg.example.com>'
    # /var/log/apache2/* logs
    env.access_log = 'suwakiorg.log'
    env.error_log = 'suwakiorg-errors.log'
...
def test():
    ...
    result = run('cd %(path)s; %(python)s manage.py test' % env)
